...
/*
! SENTENCIAS SWITCH
? Es una instruccion de flujo de control que prueba el valor de una expresión contra varias casos. Controla igualdad estricta ===
*/

console.warn('Arranco el programa')

//let diaSemana = 'LUNES'
let diaSemana = prompt('Ingrese un dia de semana en mayúscula')
...
switch (diaSemana) {
  ...
  case 'JUEVES':
  case 'VIERNES':
    console.log(`El ${diaSemana} es dia laborable`)
    break; 
  case 'SABADO':
  case 'DOMINGO':
    console.log(`El ${diaSemana} es dia no laborable`)
    break; 
  default:
    console.log('Lo que ingreso no es un día válido')
    break;
}
